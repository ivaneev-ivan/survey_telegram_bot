...
По нажатию кнопки "Получить вопросы и ответы" бот отправит вопросы  и ответы на них. Нажав на кнопку "Добваить вопросы и ответы", можно загрузить вопрос с ответом для пополнения базы знаний бот. Если Вы ввели некорректный вопрос или ответ, то нажмите на кнопку "Отменить" для выхода из режима добваления вопроса'''
                           )
